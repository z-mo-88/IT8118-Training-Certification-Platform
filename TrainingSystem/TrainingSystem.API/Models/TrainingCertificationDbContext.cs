...
public partial class TrainingCertificationDbContext : DbContext
{
    public TrainingCertificationDbContext()
    {
    }

    public TrainingCertificationDbContext(DbContextOptions<TrainingCertificationDbContext> options)
        : base(options)
    {
    }
